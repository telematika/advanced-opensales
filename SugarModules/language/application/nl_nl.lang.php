 ...
 * @author OpenSesame ICT BV <wieger.kunst@osict.com> Dutch Translation for this package
 */
...
$app_list_strings['moduleList']['AOS_Products_Quotes'] = 'Produkt aanbieding';
$app_list_strings['moduleList']['AOS_Quotes'] = 'Aanbiedingen';
...
$app_list_strings['quote_stage_dom']['Delivered'] = 'Geleverd';
...
$app_list_strings['quote_stage_dom']['Closed Dead'] = 'Dood';
...
$app_list_strings['approval_status_dom']['Not Approved'] = 'Afgekeurd';
$app_list_strings['approval_status_dom'][''] = '';
$app_list_strings['vat_list']['5.0'] = '5.0';
$app_list_strings['vat_list']['7.5'] = '7.5';
$app_list_strings['vat_list']['17.5'] = '17.5';
$app_list_strings['vat_list']['20.0'] = '20.0';
$app_list_strings['discount_list']['Percentage'] = 'Percentage';
$app_list_strings['discount_list']['Amount'] = 'Hoeveelheid';
...
$app_list_strings['invoice_status_dom']['Unpaid'] = 'Nog niet betaald';
...
$app_list_strings['product_quote_parent_type_dom']['AOS_Quotes'] = 'Aanbiedingen';
$app_list_strings['product_quote_parent_type_dom']['AOS_Invoices'] = 'Facturen';
$app_list_strings['pdf_template_type_dom']['Quotes'] = 'Aanbiedingen';
$app_list_strings['pdf_template_type_dom']['Invoices'] = 'Facturen';
...
$app_list_strings['contract_status_list']['Signed'] = 'Getekend';
$app_list_strings['contract_type_list']['Type'] = 'Type';
$app_strings['LBL_GENERATE_LETTER'] = 'Genereer brief';
$app_strings['LBL_SELECT_TEMPLATE'] = 'Kies een template';
$app_strings['LBL_NO_TEMPLATE'] = 'ERROR\nGeen template gevonden.\nGa naar de template module en maak een PDF template';
