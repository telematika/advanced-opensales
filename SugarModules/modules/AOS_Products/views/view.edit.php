...
class AOS_ProductsViewEdit extends ViewEdit {
	...
	function display(){
		...
		$temp = str_replace($sugar_config['site_url'].'/'.$sugar_config['upload_dir'],"", $this->bean->product_image);
		...
		'.$temp.'<input type=\'hidden\' name=\'old_product_image\' value=\''.$this->bean->product_image.'\'/><input type=\'hidden\' name=\'old_id\' value=\'{'.$fields.id.value.'}\'/>
