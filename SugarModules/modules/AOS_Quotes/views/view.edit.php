...
class AOS_QuotesViewEdit extends ViewEdit {
	...
	function populateLineItems(){
		...
		$html = "";
		$html .= '<script language="javascript">setModule("AOS_Quotes");</script>';
		...
		if(preg_match('/^6\.?[2]/', $sugar_config['sugar_version'])){
	...
	document.getElementById('shipping_amount').onblur = function() {calculateGrandTotal();}
	...
	document.getElementById('list_price').innerHTML = SUGAR.language.get("AOS_Quotes", "LBL_LIST_PRICE") + " (" + symbol + ")";
	document.getElementById('unit_price').innerHTML = SUGAR.language.get("AOS_Quotes", "LBL_UNIT_PRICE") + " (" + symbol + ")";
	document.getElementById('vat_amt').innerHTML = SUGAR.language.get("AOS_Quotes", "LBL_VAT_AMT") + " (" + symbol + ")";
	document.getElementById('total_price').innerHTML = SUGAR.language.get("AOS_Quotes", "LBL_TOTAL_PRICE") + " (" + symbol + ")";
	document.getElementById('service_price').innerHTML = SUGAR.language.get("AOS_Quotes", "LBL_SERVICE_PRICE") + " (" + symbol + ")";
	document.getElementById('lbl_serv_vat_amt').innerHTML = SUGAR.language.get("AOS_Quotes", "LBL_VAT_AMT") + " (" + symbol + ")";
	document.getElementById('lbl_serv_total_price').innerHTML = SUGAR.language.get("AOS_Quotes", "LBL_TOTAL_PRICE") + " (" + symbol + ")";
