...
function calculateDiscount(ln)
{
	...
	document.getElementById('product_list_price' + ln).value = formatNumber(listPrice);
...
if(prodLine == 0)
{
	...
	a.innerHTML="<input type='text' name='product_qty[]' id='product_qty" + ln + "' size='6' maxlength='6' value='' title='' tabindex='116' onblur='Quantity_formatNumber(" + ln + ");calculateProductLine(" + ln + ");'>";
	b.innerHTML="<input class='sqsEnabled' autocomplete='off' type='text' name='product_name[" + ln + "]' id='product_name" + ln +"' size='16' maxlength='50' value='' title='' tabindex='116' value=''><input type='hidden' name='product_id[" + ln + "]' id='product_id" + ln + "' size='20' maxlength='50' value=''>";
	...
	c.innerHTML="<input type='text' name='product_list_price[" + ln + "]' id='product_list_price" + ln + "' size='16' maxlength='50' value='' title='' tabindex='116' onfocus='calculateDiscount(" + ln + ");'><input type='hidden' name='product_cost_price[" + ln + "]' id='product_cost_price" + ln + "' value=''  />";
	d.innerHTML="<input type='text' name='product_discount[]' id='product_discount" + ln + "' size='16' maxlength='50' value='' title='' tabindex='116' onfocus='calculateDiscount(" + ln + ");' onblur='calculateDiscount(" + ln + ");'><input type='hidden' name='product_discount_amount[]' id='product_discount_amount" + ln + "' value=''  />";
	e.innerHTML="<input type='text' name='product_unit_price[]' id='product_unit_price" + ln + "' size='16' maxlength='50' value='' title='' tabindex='116' readonly='readonly' onfocus='calculateDiscount(" + ln + ");' onblur='calculateProductLine(" + ln + ");'>";
	f.innerHTML="<input type='text' name='vat_amt[]' id='vat_amt" + ln + "' size='16' maxlength='250' value='' title='' tabindex='116' readonly='readonly'>";	
	g.innerHTML="<input type='text' name='product_total_price[]' id='product_total_price" + ln + "' size='16' maxlength='50' value='' title='' tabindex='116' readonly='readonly'>";
	h.innerHTML="<input type='hidden' name='product_deleted[]' id='product_deleted" + ln + "' value='0'><input type='hidden' name='product_quote_id[]' value=''><button type='button' class='button' value='" + deleteButtonValue + "' tabindex='116' onclick='markProductLineDeleted(" + ln + ")'><img src='themes/default/images/id-ff-clear.png' alt='" + deleteButtonValue + "'></button><br>";
	
   	enableQS(true);

	currencyFields.push("product_list_price" + ln);
	currencyFields.push("product_cost_price" + ln);
	currencyFields.push("product_unit_price" + ln);
	currencyFields.push("vat_amt" + ln);	
	currencyFields.push("product_total_price" + ln);	

	var y=document.getElementById('productLine').insertRow(-1);
	y.id='product_note_line'+ln;
	...
	j.innerHTML="<textarea tabindex='116' name='product_note[]' id='product_note" + ln + "' rows='1' cols='23'></textarea>&nbsp;&nbsp;";
	...
	m.innerHTML=SUGAR.language.get(module, 'LBL_VAT')+" %&nbsp; :&nbsp;&nbsp;<select tabindex='116' name='vat[]' id='vat" + ln + "' onchange='calculateProductLine(" + ln + ");'>"+ vat_hidden +"</select>";
...
function insertServiceLine(ln)
{
	...
	a.innerHTML="<textarea name='product_name[]' id='service_name" + ln +"' size='16' cols='60' title='' tabindex='116' maxlength='255' onkeypress='return imposeMaxLength(this);'></textarea><input type='hidden' name='product_id[]' id='service_id" + ln + "' size='20' maxlength='50' value='0'>";
	b.innerHTML="<input type='text' name='product_unit_price[]' id='service_unit_price" + ln + "' size='16' maxlength='50' value='' title='' tabindex='116'   onblur='calculateServiceLine(" + ln + ");'>";
	c.innerHTML="<input type='text' name='vat_amt[]' id='ser_vat_amt" + ln + "' size='16' maxlength='250' value='' title='' tabindex='116' readonly='readonly'><br>"+SUGAR.language.get(module, 'LBL_VAT')+" %&nbsp; :&nbsp;&nbsp;<select tabindex='116' name='vat[]' id='ser_vat" + ln + "' onchange='calculateServiceLine(" + ln + ");'>"+ vat_hidden +"</select>";	
	d.innerHTML="<input type='text' name='product_total_price[]' id='service_total_price" + ln + "' size='16' maxlength='50' value='' title='' tabindex='116' readonly='readonly'>";
	e.innerHTML="<input type='hidden' name='product_deleted[]' id='ser_deleted" + ln + "' value='0'><input type='hidden' name='product_quote_id[]' value=''><button type='button' class='button' value='" + deleteButtonValue + "' tabindex='116' onclick='markServiceLineDeleted(" + ln + ")'><img src='themes/default/images/id-ff-clear.png' alt='" + deleteButtonValue + "'></button><br>";
	
	currencyFields.push("service_unit_price" + ln);
	currencyFields.push("ser_vat_amt" + ln);
	currencyFields.push("service_total_price" + ln);	
...
{
	document.getElementById('product_list_price' + ln).value = formatNumber(ConvertFromDollar(document.getElementById('product_list_price' + ln).value, lastRate));
